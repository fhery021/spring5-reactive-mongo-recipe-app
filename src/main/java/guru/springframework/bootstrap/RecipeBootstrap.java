...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        ...
        log.info("Count unitOfMeasureReactiveRepository = " +
                unitOfMeasureReactiveRepository.count()
                .block()
                .toString());

        log.info("Count of categoryReactiveRepository = " +
                categoryReactiveRepository.count()
                .block()
                .toString());

        log.info("Count of recipeReactiveRepository = " +
